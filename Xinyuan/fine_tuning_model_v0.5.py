...
file_name = os.getenv("DATA", "./testing_data/mushroom.en-val.v2.jsonl")   # set the val set as default training set
...
# %%
# peek the tokenized datasets
print(train_dataset[0]['labels'])
print(train_dataset[0]['hard_labels'])
...
fine_tuned_model_path = "./models/bert" + name_tag + "_" + str(num_epochs) + "_epochs"
